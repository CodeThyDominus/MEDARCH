...
if (isset($_POST['docsub1'])) {
  if (isset($_POST['doctorsToDelete']) && is_array($_POST['doctorsToDelete'])) {
    $doctorsToDelete = $_POST['doctorsToDelete'];
    $con = mysqli_connect("localhost", "root", "", "myhmsdb");

    foreach ($doctorsToDelete as $doctorName) {
      $query = "DELETE FROM doctb WHERE username='$doctorName';";
      $result = mysqli_query($con, $query);

      if ($result) {
        echo "<script>alert('Doctor(s) removed successfully!');</script>";
      } else {
        echo "<script>alert('Unable to delete doctor(s)');</script>";
      }
    }
  }
}
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> MEDARCH </a>
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'Poppins', sans-serif;"> WELCOME ADMIN </h3>
    <div class="row">
  <div class="col-md-3" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" id="list-dash-list" data-toggle="list" href="#list-dash" role="tab" aria-controls="home"><b>Dashboard</b></a>
        ...
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
               <div class="col-sm-3">
                ...
                <div class="col-sm-3" style="left: -3%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
                ...
                <div class="row">
                <div class="col-sm-3" style="left: 13%;margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                ...
                <div class="col-sm-3" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
  ...
  <div class="row">
    <!-- Change the input name to "doctor_name" -->
    <div class="col-md-10"><input type="text" name="doctor_name" placeholder="Enter Doctor Name" class="form-control"></div>
  ...
  <form class="form-group" action="patientsearch.php" method="post">
    <div class="row">
      <div class="col-md-10"><input type="text" name="patient_name" placeholder="Enter Name" class="form-control"></div>
      ...
      <form class="form-group" action="appsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="app_contact" placeholder="Enter Name" class = "form-control"></div>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
  ...
  <form class="form-group" method="post" action="admin-panel1.php">
    <h4>Select doctors to delete:</h4>
    <?php
    $con = mysqli_connect("localhost", "root", "", "myhmsdb");
    $query = "SELECT * FROM doctb";
    $result = mysqli_query($con, $query);
    ...
    ?>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" name="doctorsToDelete[]" value="<?php echo $doctorName; ?>">
    ...
    ?>
    <br>
    <input type="submit" name="docsub1" value="Delete Selected Doctors" class="btn btn-primary" onclick="return confirm('Do you really want to delete selected doctors?')">
  </form>
</div>
...
<div class="tab-pane fade" id="list-attend" role="tabpanel" aria-labelledby="list-attend-list">...</div>
  ...
  <div class="col-md-8">
    <form class="form-group" action="messearch.php" method="post">
      <div class="row">
        <div class="col-md-6">
          <input type="text" name="mes_name" placeholder="Enter Name" class="form-control">
        </div>
        <div class="col-md-4">
          <input type="text" name="mes_keyword" placeholder="Enter Keyword" class="form-control">
        </div>
        <div class="col-md-2">
          <input type="submit" name="mes_search_submit" class="btn btn-primary" value="Search">
        </div>
      </div>
    </form>
  </div>
